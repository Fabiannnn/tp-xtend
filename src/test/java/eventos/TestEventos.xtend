...
class TestEventos {
	...
	def void init() {
		...
		cumple = new EventoAbierto("Cumple de Algoritmos 2", usuario1, salon_SM, hoyMasTres, hoyMasCinco,
			LocalDate.of(2018, 05, 30), 17, 20.5)
		reunionTrabajo = new EventoCerrado("Reunion proyecto", usuario1, salon_SM, hoyMasTres, hoyMasCinco,
