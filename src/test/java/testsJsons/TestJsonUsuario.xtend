...
class TestJsonUsuario extends FixtureTest {
	...
	def void seAgrega2UsuariosValidosyAplicamosActualizJson2UnoExistente() {
		...
		usuario3.nombreUsuario = "MariGomez"
		repoUsuario.create(usuario3)
		jsonText2 = '''[{ "nombreUsuario" : "MariGomez","nombreApellido":"Lucas Perez","email":"lucas_93@hotmail.com","fechaNacimiento":"15/01/1993","direccion":{"calle":"25 de Mayo","numero":3918,"localidad":"San Martín","provincia":"Buenos Aires",  "coordenadas":{
										"x":-34.572224,
										"y":58.535651
									}  }}, { "nombreUsuario" : "otro_lucas","nombreApellido":"Lucas Otro","email":"lucas_93@hotmail.com","fechaNacimiento":"15/01/1993","direccion":{"calle":"25 de Mayo","numero":3918,"localidad":"San Martín","provincia":"Buenos Aires",  "coordenadas":{
															"x":-34.572224,
